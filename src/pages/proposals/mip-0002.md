# Adopt the DAO Treasury Diversification
...
**RESOLVED:** That DAO Multi-sig at [`0x143cC0A996De329C1C5723Ee4F15D2a40c1203c6`](https://etherscan.io/address/0x143cC0A996De329C1C5723Ee4F15D2a40c1203c6) shall execute the following transactions:

**RESOLVED:** Swap 500,000.00 DAI[^1] for ETH[^2];

**RESOLVED:** Swap 10,000,000.00 DAI for cDAI[^3] to earn interest at 0.67% APY; and;

**RESOLVED:** Swap 1,000 ETH for Lido stETH[^4] to earn 3.9% APY.
