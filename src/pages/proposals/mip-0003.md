...
Currently, payouts are privately funded, development and staffing is inconsistent, processes are opaque and invoke major overhead for contributors, and these process are primarily managed by tankbottoms.eth, his private company Meow, and dao-lawfirm.eth.
...
-   A Juicebox Protocol DAI terminal has not been deployed to mainnet, meaning these funds must be held in Gnosis Safes.
