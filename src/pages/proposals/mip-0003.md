...
Transfer `1,750,000 DAI` from the DAO Multisig[^1] to the Developer Multisig[^2] to bootstrap product develop by funding 4 months of development and minimal operations, including:
...
This payout includes retroactive reimbursements and covering expenses borne by **dao-lawfirm.eth**, **tankbottoms.eth**, and **ryan-breslow.eth**.
This payout includes retroactive compensation to **tankbottoms.eth** and a number of development individuals.
This payout includes up to _$250,000.00_ to opportunistically purchase Juicebox Governance (JBX).
This payout includes ongoing expenses borne by **dao-lawfirm.eth** and **tankbottoms.eth** such as subscription services, hosting providers, Web3 providers, Fleek and other online services.
...
Both the developer and business development budgets are utilized at the discretion of **tankbottoms.eth**, **jimmyethworld.eth**, with oversight from the Service Providers, **dao-lawfirm.eth**. Additional signers will be added after a probationary period of ~30-90 days to ensure that the DAO's interests are being represented.
...
**RESOLVED:** That the DAO Multi-signature transfer of 1,750,000 DAI to the Developer Multi-sig (hereinafter, "Bootstrap Payment") is hereby adopted and approved;

**RESOLVED FURTHER:** That a portion of the Bootstrap Payment will be used to reimburse DAO expenses or past obligations paid by **dao-lawfirm.eth**, **tankbottoms.eth**, and **ryan-breslow.eth**, is hereby adopted; and,

**RESOLVED FURTHER:** That the Service Providers (authorized member and secretary **benreed.eth**), in accordance with commensurate powers, is authorized to execute and deliver any agreement in the name of the DAO and to otherwise obligate the DAO with respect to the purpose of the DAO, within general guidelines and budgets approved by the Members; provided, however, that Actions by the DAO Snapshot Consensus by the Members may adopt specific limitations on the authority of the Service Provider from time to time.

**FURTHER RESOLVED:** That the Service Providers are authorized to pay and reimburse the past expenses of incorporation and organization, development, engineering compensation, subscriptions, expenses of the DAO and their affiliate entities, including without limitation expenses incurred prior to the unincorporation, incorporation, etc of the entities.
...
**RESOLVED FURTHER:** That the Service Providers is authorized to consult with its bookkeepers, auditors and attorneys in order to be fully informed as to, and to collect and pay promptly when due, all withholding taxes for which the Service Provider, Authorized Members, DAO, or affiliate Entities may now be (or hereafter become) liable.

**RESOLVED FURTHER:** That the Service Providers are authorized to take any and all actions that they deem necessary or appropriate to qualify the DAO, and its affiliates entities to do business as a foreign corporation in each state that the **Authorized Members** determine such qualification to be necessary or appropriate.

Insofar as the prior member authorization either was neither comprehensive or contemplated all of the DAO affiliate entities, the Service Providers, are hereby reauthorized to apply for and direct responsible legal resources for the DAO affiliate entities the following application relating to Form SS-4.
...
**RESOLVED FURTHER:** That the Service Providers be, and each of them hereby is, authorized and empowered to take any and all such further action, to execute and deliver any and all such further agreements, instruments, documents and certificates and to pay such expenses, in the name and on behalf of the DAO, existing affiliates entities, contemplated affiliate entities, or such Authorized Member, as any such Authorized Member may deem necessary or advisable to effectuate the purposes and intent of the resolutions hereby adopted, the taking of such actions, the execution and delivery of such agreements, instruments, documents and certificates and the payment of such expenses by any such Authorized Member to be conclusive evidence of his or her authorization hereunder and the approval thereof.
