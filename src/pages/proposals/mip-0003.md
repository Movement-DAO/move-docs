...
- A Juicebox Protocol DAI terminal has not been deployed to mainnet, meaning these funds must be managed by Multisignature wallets.
...
**RESOLVED:** That the DAO Multisignature transfer of 1,750,000 DAI to the Developer Multisig (hereinafter, "Bootstrap Payment") is hereby adopted and approved;
