# Adopt Service Provider Actions and Authorized Member Actions
...
**RESOLVED:** The DAO hereby adopt all prior acts related to agreements, and payments by the [Service Provider](https://dao-lawfirm.xyz).
...
**RESOLVED:** That the DAO, through its Service Provider, determines that it is in the best interest of the DAO, its affiliates, and its Members for the DAO to enter into indemnification agreements with its current and future Service Providers in substantially the form attached hereto.
...
**RESOLVED FURTHER:** That the Service Provider and the authorized members of the DAO are authorized to make modifications to such agreements in order to comply with applicable law.
