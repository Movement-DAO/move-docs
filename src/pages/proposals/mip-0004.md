...
The DAO hereby ratifies the establishment of the following affiliates: **DAOLABS, LLC.**, **DAOLABS, INC.** and any permutations thereof, as well as the establishment of **PeaceDAO Unincorporated Nonprofit Association**.

This proposal ratifies the actions of certain individuals to formalize entities as either a Washington or Delaware entity, establish the DAO's banking account, and register the DAO's affiliates, including **DAOLABS, LLC**, **DAOLABS, Inc.** and any permutations thereof, together which are referred to herein as the **"DAO Group"** or **"DAO affiliates"**.
