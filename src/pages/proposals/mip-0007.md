...
**Snapshot**is a decentralized voting system which provides flexibility on voting power calculation, various voting types, the creation of proposals, and the verification of voters off-chain, with the requirement to use the Ethereum blockchain which enables easy to verify and hard to contest results robust for governance with unincorporated associations to very large participation base thereby enabling diverse decentralized decision making, previously only possible with highly coordinated shareholder meetings without any costs. The DAO and its affiliates entities use Snapshot in order to verify and calculate Membership consensus.
...
**RESOLVED:** The **Service Providers** as defined by the Guiding Principals Section 16(a)-(d) and specifically as [dao-lawfirm.eth](https://dao-lawfirm.xyz), Attorney Reed Yurchak of the Law Offices of Reed Yurchak, and forensic blockchain engineer tankbottoms.eth. Every action that has been taken, authorized, unauthorized, and with respect to the DAO by the **Service Providers** including, but not limited to, the transfer of Cryptocurrency to and from Gnosis Multi-Signature Wallets, externally owned wallets, Coinbase, Robinhood, and any other addresses, i.e. Uniswap, Matcha, OpenSea, etc, the appointment of the Authorize Member, and any of their affiliates, together (**“Service Providers”**), authorship of any documents, agreements, documents, filing of the Guiding Principles, registering of the DAO's EIN, the establishment of any affiliates such as any for-profit entities, DAOLABS, Movement DAO, Peace DAO, Treasury, are hereby ratified.
...
**RESOLVED FURTHER:** That the principal office of the DAO and its affiliate entities be established and maintained by the Service Provider at _601 Brickell Key Drive, Ste. 701, Miami, FL 33131_.
...
**RESOLVED FURTHER:** That the **Service Providers** are authorized to direct the responsible attorneys, paralegals and corporate assistants of the lawfirm or counsel for the DAO, to submit on behalf of the DAO, an online application for a federal employer identification number on Form SS-4.
